...
def compute_l1_score(original_image_path, perturbed_image_path):
    # Load images
    ...
    l1_score = np.sum(np.abs(difference))   
...
print(f'Estimated epsilon for high noise (L-infinity norm): {compute_l1_score("aeroplane0.jpeg", "aeroplane0-noise-high.jpeg")}')
print(f'Estimated epsilon for low noise (L-infinity norm): {compute_l1_score("aeroplane0.jpeg", "aeroplane0-noise-low.jpeg")}')
print(f'Estimated epsilon for high blur (L-infinity norm): {compute_l1_score("aeroplane0.jpeg", "aeroplane0-zoomblur-high.jpeg")}')
print(f'Estimated epsilon for low blur (L-infinity norm): {compute_l1_score("aeroplane0.jpeg", "aeroplane0-zoomblur-low.jpeg")}')
